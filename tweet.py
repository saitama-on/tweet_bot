...
if __name__ == "__main__":
    nest_asyncio.apply()  # Required to run Flask + asyncio together on same loop

    loop = asyncio.get_event_loop()
    loop.create_task(main())  # Start news loop as background task
